...
<html lang="en">
   ...
   <main class="container-fluid h-100" style="min-height: 896px;">
        <div class="row h-100 overflow-auto">
            ...
            <div class="col-10 col-md-6 col-lg-5 col-xl-3 mx-auto align-self-center text-center py-4">
                ...
                <form class="was-validated needs-validation" novalidate="">
                    ...
                    <button type="button" class="btn btn-lg btn-default w-100 mb-4 shadow" onclick="window.location.replace('index.php');">
                        Sign in
                    </button>
                </form>
                <p class="mb-2 text-muted">Don't have account?</p>
                <a href="signup.php" target="_self" class="">
