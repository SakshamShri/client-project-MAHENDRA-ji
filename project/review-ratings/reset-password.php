        ...
        <div class="row h-100 overflow-auto">
            <div class="col-12 text-center mb-auto px-0">
                <header class="header">
                    <div class="row">
                        <div class="col-auto">
                            <a href="forgot-password.php" target="_self" class="btn btn-light btn-44"><i class="bi bi-arrow-left"></i></a>
                        </div>
                        <div class="col">
            ...
            <div class="col-10 col-md-6 col-lg-5 col-xl-3 mx-auto align-self-center text-center py-4">
                ...
                <a href="thankyou.php" target="_self" class="btn btn-lg btn-default w-100 shadow">Update</a>
            </div>
